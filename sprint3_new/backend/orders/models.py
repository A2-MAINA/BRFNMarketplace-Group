...
class Order(models.Model):
    ...
    # Shows a readable summary of the order in admin screens and logs.
    def __str__(self):
        return f"Order #{self.pk} — {self.customer.email} — {self.get_status_display()}"

    # Auto-populates invoice metadata the first time an order is saved.
    ...
    # Checks whether the order is still within the allowed customer cancellation window.
    ...
    # Recomputes the order-level totals from all producer groups attached to the order.
...
class OrderProducerGroup(models.Model):
    ...
    # Shows the producer group as a readable order line in Django admin and logs.
    def __str__(self):
        return (
    ...
    # Calculates subtotal, commission, payout, and delivery fee for one producer group.
...
class OrderItem(models.Model):
    ...
    # Returns the snapshot line total for this ordered product.
    ...
    # Shows a readable description of the order item in admin and logs.
    def __str__(self):
        return (
...
class OrderStatusHistory(models.Model):
    ...
    # Shows the recorded order status change in a human-friendly format.
    def __str__(self):
        return (
...
class Payment(models.Model):
    ...
    # Shows the payment status and amount for the related order.
    def __str__(self):
        return (
